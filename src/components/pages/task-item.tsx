...
export const TaskItem = ({ data, onCheck, onRemove }: { data: Todo; onCheck?: () => void; onRemove?: () => void }) => {
  return (
    <div className="flex bg-gray-100 shadow p-2 items-center rounded-sm">
      ...
      <button onClick={onRemove} className="bg-red-500 p-2 rounded-md text-white">
        Delete
      </button>
    </div>
  );
